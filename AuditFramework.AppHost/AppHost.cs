...
var temporal = builder.AddContainer("temporal", "temporalio/auto-setup", "1.25.2")
...
var temporalUi = builder.AddContainer("temporal-ui", "temporalio/ui", "2.31.2")
    .WithEnvironment("TEMPORAL_ADDRESS", "temporal:7233")
    .WithHttpEndpoint(port: 8233, targetPort: 8080, name: "http")
    .WithExternalHttpEndpoints()
    .WaitFor(temporal);

var apiService = builder.AddProject<Projects.AuditFramework_ApiService>("apiservice")
    .WithReference(auditDb)
    .WithEnvironment("Temporal__Address", "temporal:7233")
    .WithHttpHealthCheck("/health");

builder.AddProject<Projects.AuditFramework_Web>("webfrontend")
    .WithExternalHttpEndpoints()
    .WithHttpHealthCheck("/health")
